...
import static com.dbr.doom.engine.data.Defines.HU_FONTSIZE;
import static com.dbr.doom.engine.data.Defines.HU_FONTSTART;
import static com.dbr.doom.engine.data.Defines.PU_CACHE;
import static com.dbr.doom.engine.data.Defines.SAVESTRINGSIZE;
import static com.dbr.doom.engine.data.dstrings.NUM_QUITMESSAGES;
import static com.dbr.doom.engine.data.dstrings.SAVEGAMENAME;
import static com.dbr.doom.engine.data.dstrings.endmsg;
...
import com.dbr.doom.engine.doom.SourceCode;
import com.dbr.doom.engine.doom.SourceCode.M_Menu;
import static com.dbr.doom.engine.doom.SourceCode.M_Menu.M_Responder;
import static com.dbr.doom.engine.doom.SourceCode.M_Menu.M_StartControlPanel;
import static com.dbr.doom.engine.doom.SourceCode.M_Menu.M_Ticker;
import com.dbr.doom.engine.doom.englsh;
import static com.dbr.doom.engine.doom.englsh.DOSY;
import static com.dbr.doom.engine.doom.englsh.EMPTYSTRING;
import static com.dbr.doom.engine.doom.englsh.ENDGAME;
import static com.dbr.doom.engine.doom.englsh.GAMMALVL0;
import static com.dbr.doom.engine.doom.englsh.GAMMALVL1;
import static com.dbr.doom.engine.doom.englsh.GAMMALVL2;
import static com.dbr.doom.engine.doom.englsh.GAMMALVL3;
import static com.dbr.doom.engine.doom.englsh.GAMMALVL4;
import static com.dbr.doom.engine.doom.englsh.LOADNET;
import static com.dbr.doom.engine.doom.englsh.MSGOFF;
import static com.dbr.doom.engine.doom.englsh.MSGON;
import static com.dbr.doom.engine.doom.englsh.NETEND;
import static com.dbr.doom.engine.doom.englsh.NEWGAME;
import static com.dbr.doom.engine.doom.englsh.NIGHTMARE;
import static com.dbr.doom.engine.doom.englsh.QLOADNET;
import static com.dbr.doom.engine.doom.englsh.QLPROMPT;
import static com.dbr.doom.engine.doom.englsh.QSAVESPOT;
import static com.dbr.doom.engine.doom.englsh.QSPROMPT;
import static com.dbr.doom.engine.doom.englsh.SAVEDEAD;
import static com.dbr.doom.engine.doom.englsh.SWSTRING;
...
import com.dbr.doom.engine.timing.DelegateTicker;
...
public class Menu<T, V> extends AbstractDoomMenu<T, V> {
    ...
    public void Init() {
        ...
        /*
         * DbrDoomMod: an IWAD can carry fewer episodes than its game mode
         * implies. The mode is decided by the file's name, so a trimmed WAD
         * still claims every episode, and choosing one whose maps are absent
         * drops the player into a failed load with no explanation.
         *
         * Trim from the top down until the last listed episode is one that
         * actually has a first map. General on purpose: it reads the WAD rather
         * than assuming anything about which WAD is present.
         */
        while (EpiDef.numitems > 1
                && DOOM.wadLoader.CheckNumForName("E" + EpiDef.numitems + "M1") < 0) {
            EpiDef.numitems--;
        }
    }
