...
import com.dbr.doom.engine.data.musicinfo_t;
import com.dbr.doom.engine.data.sfxinfo_t;
import com.dbr.doom.engine.data.sounds;
import static com.dbr.doom.engine.data.sounds.S_sfx;
...
public class AbstractDoomAudio implements IDoomSound{
			...
			vps_t vps)
	{
		...
		angle = com.dbr.doom.engine.rr.RendererState.PointToAngle(listener.x,
				listener.y,
				source.getX(),
				source.getY());
		...
		// Quickly decide sign of pitch based on speed vectors
			...
			angle = com.dbr.doom.engine.rr.RendererState.PointToAngle(listener.momx,
					listener.momy,
					source.momx,
					source.momy);
