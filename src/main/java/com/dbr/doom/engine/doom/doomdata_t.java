...
public class doomdata_t implements IDatagramSerializable {
	...
	public static final int DOOMDATALEN = 8 + com.dbr.doom.engine.data.Defines.BACKUPTICS * ticcmd_t.TICCMDLEN;
	...
	public doomdata_t() {
		cmds = malloc(ticcmd_t::new, ticcmd_t[]::new, com.dbr.doom.engine.data.Defines.BACKUPTICS);
