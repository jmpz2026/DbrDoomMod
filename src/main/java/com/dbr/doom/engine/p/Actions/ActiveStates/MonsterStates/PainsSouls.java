 ...
 */
package com.dbr.doom.engine.p.Actions.ActiveStates.MonsterStates;

import static com.dbr.doom.engine.data.Limits.MAXSKULLS;
...
import com.dbr.doom.engine.p.Actions.ActionTrait;
...
public interface PainsSouls extends ActionTrait {
    static final int SKULLSPEED = 20 * com.dbr.doom.engine.m.fixed_t.MAPFRACUNIT;
