...
import com.dbr.doom.engine.doom.SourceCode.W_Wad;
import static com.dbr.doom.engine.doom.SourceCode.W_Wad.W_CacheLumpName;
import static com.dbr.doom.engine.doom.SourceCode.W_Wad.W_CheckNumForName;
import com.dbr.doom.engine.i.DummySystem;
		...
		if ((lumpcache[lump] == null)||(what==null)) {
			...
			if (what != null) {
				try {
					...
					if (implementsInterface(what, com.dbr.doom.engine.w.CacheableDoomObject.class)) {
